  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 relative overflow-x-hidden">
      <section className="relative pt-32 pb-24 px-6 text-center overflow-hidden min-h-[70vh] flex items-center justify-center">
        ...
        <div
          className="absolute inset-0 z-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.04)_1px,transparent_1px)] bg-[size:40px_40px] animate-grid-scroll"
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <motion.h2
            ...
            className="mt-6 text-lg md:text-xl text-slate-600 font-medium max-w-2xl mx-auto"
          >
            Join the AI-Powered Teenpreneur Workshop by Teenskool. No coding. No
            prior experience. Just ideas, AI, and action.
          </motion.h2>
      ...
      <section className="py-24 px-6 bg-slate-100 border-y border-slate-200">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <Link to="/contact">
              <button className="bg-yellow-400 mt-4 hover:bg-yellow-500 text-slate-900 font-semibold py-3 px-6 rounded-lg w-full shadow-lg shadow-yellow-400/20 transition flex items-center justify-center gap-2">
          ...
          >
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <button className="bg-slate-800 mt-4 hover:bg-slate-900 text-white font-semibold py-3 px-6 rounded-lg w-full shadow-md transition flex items-center justify-center gap-2">
